...
export default function IssueDetailPage() {
  ...
  async function upload(file) { setError(''); setMessage(''); try { await attachmentApi.uploadAttachment(issueKey, file); await load(); setMessage('Report uploaded successfully.'); return true; } catch (requestError) { setError(requestError.message); return false; } }
